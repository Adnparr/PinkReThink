    ...
    <header className="flex items-center justify-between whitespace-nowrap border-b border-white/5 px-6 py-4 lg:px-20 bg-background-dark/40 backdrop-blur-xl sticky top-0 z-50">
      <div className="flex items-center gap-8">
        <Link href="/landingpage" className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-black tracking-tight text-white hover:text-primary transition-colors">PinkReThink</h1>
        </Link>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden sm:flex items-center bg-white/5 rounded-xl px-3 py-1.5 border border-white/10 group focus-within:border-primary/50 transition-colors">
          <span className="material-symbols-outlined text-primary/60 text-lg group-focus-within:text-primary transition-colors">search</span>
          <input className="bg-transparent border-none focus:ring-0 text-sm placeholder:text-slate-500 text-white w-32 lg:w-48 ml-2 outline-none" placeholder="Search..." type="text" />
        </div>
        ...
        <div className="relative group ml-2">
          <button className="flex size-10 rounded-full bg-primary/20 items-center justify-center overflow-hidden border-2 border-primary/20 hover:border-primary transition-colors cursor-pointer">
            ...
            <img className="w-full h-full object-cover" alt="Profile picture" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCSDl6RKegM-0Mx75zvCKWN2TvFdVFsad_LUjy9jH-c9hm0de-S4gzyDbTusmyxzpmsacoCZ18QHkLdcysZ0G_XgBpEoxn6e0PqSxfBKaPSoPmHdaH-Zs813GDfj-IsslZSQYAOX-mQGxXcOmJIiHB9iGlNLgODB7iRwQJqzAt2WBshGM-HlHroFBOpaHVfmXGUz0lABBZawi6e0yIjKhDbCmS6BDNK13I6SONyphuJUXxTV_nws28oFN27oR_4O7dJXC4lTCm-EDQC" />
          </button>
          ...
          <div className="absolute right-0 top-full mt-2 w-48 rounded-xl bg-[#1a0b2e] border border-white/10 shadow-xl invisible opacity-0 group-hover:opacity-100 group-hover:visible transition-all origin-top-right z-50 overflow-hidden">
            <div className="flex flex-col">
              <Link href="/profile" className="flex items-center gap-3 px-4 py-3 text-sm text-slate-300 hover:text-white hover:bg-white/5 transition-colors">
                <span className="material-symbols-outlined text-lg">person</span>
                Profile & Settings
              </Link>
              <Link href="/roadmap" className="flex items-center gap-3 px-4 py-3 text-sm text-slate-300 hover:text-white hover:bg-white/5 transition-colors">
                <span className="material-symbols-outlined text-lg">hotel_class</span>
                My Progress
              </Link>
              <div className="h-px bg-white/10 w-full"></div>
              <button className="flex items-center w-full text-left gap-3 px-4 py-3 text-sm text-slate-300 hover:text-red-400 hover:bg-red-500/10 transition-colors">
