  ...
  return (
    <div className="lg:col-span-4 flex flex-col gap-5">
      ...
      <div className="bg-white/5 p-6 rounded-xl border border-white/10 flex flex-col items-center text-center backdrop-blur-md shadow-2xl shadow-black/50">
        ...
        <p className="text-primary font-medium mt-1">Senior Learner • Level 12</p>
        <p className="text-slate-500 text-sm mt-2">Member since January 2023</p>
      ...
      <div className="bg-white/5 p-6 rounded-xl border border-white/10 flex flex-col items-center text-center backdrop-blur-md shadow-2xl shadow-black/50">
        <div className="flex items-center justify-between mb-4 w-full">
          ...
          <a className="text-secondary text-sm font-semibold hover:brightness-110" href="#">View All</a>
        </div>
