    ...
    <aside className="w-full lg:w-96 border-l border-white/10 glass-panel flex flex-col h-screen lg:sticky lg:top-0">
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">Nội dung Khoá học</h2>
          <span className="text-xs font-bold text-primary">Đã hoàn thành 45%</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-6 py-4 dark:bg-slate-800/30">
          <p className="text-xs font-black uppercase tracking-widest text-slate-400">Học phần 1: Giới thiệu</p>
        </div>
        <div className="divide-y divide-primary/5">
          <div className="flex items-center gap-4 p-5 hover:bg-primary/5 transition-colors cursor-pointer hover:bg-white/5">
            ...
            <div className="flex-1 min-w-0 hover:bg-white/5">
              <p className="text-sm font-semibold text-slate-900 dark:text-white truncate">1. Chào mừng đến với Khóa học</p>
          ...
          <div className="flex items-center gap-4 p-5 hover:bg-primary/5 transition-colors cursor-pointer hover:bg-white/5">
            <input defaultChecked className="h-5 w-5 rounded border-2 border-primary text-primary focus:ring-primary focus:ring-offset-0" type="checkbox" />
            <div className="flex-1 min-w-0 hover:bg-white/5">
              <p className="text-sm font-semibold text-slate-900 dark:text-white truncate">2. Thiết lập Công cụ của Bạn</p>
        ...
        {/* Module 2 */}
        <div className="px-6 py-4 dark:bg-slate-800/30">
          <p className="text-xs font-black uppercase tracking-widest text-slate-400">Học phần 2: Các Khái niệm Cốt lõi</p>
        </div>
        <div className="divide-y divide-primary/5">
          <div className="flex items-center gap-4 p-5 active-lesson cursor-pointer hover:bg-white/5">
            ...
            <div className="flex-1 min-w-0 hover:bg-white/5">
              <p className="text-sm font-bold text-primary truncate">3. Hiểu về Phân cấp Thị giác</p>
              <p className="text-xs text-primary/70">12:45 • Đang phát</p>
            </div>
          ...
          <div className="flex items-center gap-4 p-5 hover:bg-primary/5 transition-colors cursor-pointer hover:bg-white/5">
            ...
            <div className="flex-1 min-w-0 hover:bg-white/5">
              <p className="text-sm font-semibold text-slate-900 dark:text-white truncate">4. Những điều Cốt yếu về Lý thuyết Màu sắc</p>
          ...
          <div className="flex items-center gap-4 p-5 hover:bg-primary/5 transition-colors cursor-pointer hover:bg-white/5">
            <input className="h-5 w-5 rounded border-2 border-slate-300 dark:border-slate-600 text-primary focus:ring-primary focus:ring-offset-0" type="checkbox" />
            <div className="flex-1 min-w-0 hover:bg-white/5">
              <p className="text-sm font-semibold text-slate-900 dark:text-white truncate">5. Lựa chọn Kiểu chữ</p>
        ...
        {/* Module 3 */}
        <div className="px-6 py-4 dark:bg-slate-800/30">
          <p className="text-xs font-black uppercase tracking-widest text-slate-400">Học phần 3: Bố cục Nâng cao</p>
        </div>
        <div className="divide-y divide-primary/5">
          <div className="flex items-center gap-4 p-5 hover:bg-primary/5 transition-colors cursor-pointer opacity-60 hover:bg-white/5">
            ...
            <div className="flex-1 min-w-0 hover:bg-white/5">
              <p className="text-sm font-semibold text-slate-900 dark:text-white truncate">6. Hệ thống Lưới</p>
      ...
      <div className="border-t border-primary/10 p-4">
        <button className="w-full rounded-xl bg-primary py-4 text-sm font-bold text-white shadow-[0_0_15px_rgba(242,13,128,0.4)] transition-all hover:scale-[1.02] active:scale-95">Bài học Tiếp theo</button>
      </div>
    </aside>
  );
}
