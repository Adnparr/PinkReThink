...
export default function MapView() {
  return (
    <section className="flex-1 relative min-h-[800px] overflow-hidden bg-gradient-to-b from-[#0d0208] via-[#1a0511] to-[#0a020d]">
      {/* Background Gradients and Patterns */}
      <div
        className="absolute inset-0 opacity-10 dark:opacity-20 pointer-events-none"
        style={{
          backgroundImage: "radial-gradient(#f20d80 0.8px, transparent 0.8px)",
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCNvtfBHCb7WdZrMYu03I6LFiJhNCtBTE6j9keBWStBARR3WeWslKy9HRfsdRAYgMZy3xqd3SrsDoAtVmHUnYDmznqCmBkRRyMtBqOsdO8Puf57EJyEgSXyKI8g37VaNBPPXSWY0ydh-cc3UwIOQjK5YIFTb5r5O8M5RV-G7vRi33iv9LXkUmpSwpdvhZIG3kw2u4Fx1nOPJYGng_Od8F4Cw2JyiBDYLYnGcKPyzfqQ39ycZh-ywJLABQBPTjkLIyev-Gpml4Uuw4fK')",
          }}
        ></div>
      ...
      <div className="relative w-full h-full md:p-12 overflow-y-auto">
        ...
        <div className="flex justify-between items-start mb-12">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Journey through the lands of Knowledge
            </p>
          </div>
          <div className="flex gap-3">
            <button className="bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white p-2 rounded-lg border border-white/10 transition-colors">
        ...
        <div className="relative max-w-2xl mx-auto flex flex-col items-center py-10 gap-12">
          ...
          <svg
            className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none stroke-primary/20 fill-none"
            preserveAspectRatio="none"
            viewBox="0 0 400 1200"
          >
            <path
              className="stroke-primary/40 fill-none drop-shadow-[0_0_15px_rgba(242,13,128,0.5)]"
              d="M200,50 Q250,150 150,250 T200,450 T250,650 T150,850 T200,1100"
          ...
          <Link
            href="/learn"
            className="relative group ml-48 transition-all scale-110 cursor-pointer block"
          >
            ...
            <div className="absolute left-40 top-1/2 -translate-y-1/2 bg-primary/20 backdrop-blur-xl px-6 py-4 rounded-3xl shadow-[0_20px_50px_rgba(242,13,128,0.4)] border border-white/20 min-w-[240px] group-hover:bg-primary/30 transition-colors">
              <p className="text-[10px] font-black text-rose-100 uppercase tracking-[0.2em] mb-1">
                Adventurer Position
              </p>
              <h4 className="font-black text-white text-lg">
                Cloud Grammar Heights
              </h4>
              <p className="text-xs text-rose-100/80">
                Lesson 2: Sentence Spells
              </p>
            </div>
          </Link>
          ...
          <div className="relative group">
            <div className="w-32 h-32 bg-primary/5 rounded-full shadow-inner flex items-center justify-center border-4 border-dashed border-primary/20 z-10 custom-glow-circle shadow-[0_0_20px_rgba(242,13,128,0.2)]">
              <span className="material-symbols-outlined text-primary/30 text-6xl animate-pulse">
                workspace_premium
              </span>
            </div>
            <div className="absolute top-36 left-1/2 -translate-x-1/2 text-center whitespace-nowrap">
              <h4 className="font-black text-xl text-primary drop-shadow-[0_0_8px_rgba(242,13,128,0.6)] uppercase tracking-tighter">
                Graduation Peak
              </h4>
        ...
        {/* Decorative Elements */}
        <div
          className="absolute top-40 left-20 pointer-events-none animate-bounce"
        ...
        <div
          className="absolute top-[60%] right-20 pointer-events-none animate-bounce shadow-primary"
          style={{ animationDuration: "4s" }}
        >
          <span className="material-symbols-outlined text-yellow-400/50 text-3xl">
            auto_awesome
          </span>
        </div>
        <div className="absolute bottom-[20%] left-[10%] pointer-events-none opacity-20">
          <img
            className="size-20 grayscale blur-[2px]"
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAh71wtANmPerVr5n1Z1iR1SVnr6mpOwBo4qdz8Ct7apFCfBOcj8KphfTxo72IEbmsoL1lHGmjbl5ifY5lgehYlod6TEmamBXNt4VfJb6UV5hKJd1F68eBGGktra5LDZXw7QRp6jxb8MjP-hJKAFlLbOle6zpZPH9fbHj82QgqgJQS_Tue6QQ4K75MK-_eNPnUaYMV1BiJA-TySV3g0bIvD0640Ym8kZ0GQ6EtupFZFhClb0dZVw_nCkqyOKeixXdP94_gYMBe2dITb"
            alt="Decorative Blur"
          />
        </div>
      ...
      <div className="absolute bottom-10 right-10 flex flex-col gap-4 items-end">
        <div className="bg-white/10 dark:bg-slate-900/40 backdrop-blur-xl p-4 rounded-2xl shadow-2xl border border-white/10 max-w-xs flex gap-4 items-center">
          ...
          <p className="text-sm font-medium text-slate-200">
            Tip: Completing 'Cloud Grammar' unlocks the Feathered Pen artifact!
          </p>
        </div>
