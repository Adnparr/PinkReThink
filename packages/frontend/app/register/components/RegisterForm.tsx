...
export default function RegisterForm() {
  return (
    <div className="p-8 md:p-10 bg-gradient-to-bl from-primary/[0.02] to-transparent">
      <div className="mb-8">
        <h2 className="font-black text-white leading-tight">Create Account</h2>
      ...
      <form action="#" className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-slate-200 text-sm font-semibold">Confirm Password</label>
            <div className="relative">
        ...
        <div className="relative flex items-center justify-center py-4">
          ...
          <span className="px-3 text-sm text-slate-400">or sign up with</span>
          <div className="flex-grow border-t border-slate-200 dark:border-slate-700"></div>
        </div>
