      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-12 animate-fade-in-up ">
          <div className="space-y-4">
            <h2 className="text-4xl font-black tracking-tight text-white">Khoá Học Nổi Bật</h2>
            <p className="text-slate-600 dark:text-slate-400">Khám phá các bài học phổ biến nhất của chúng tôi cho mọi lứa tuổi.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="group cursor-pointer animate-fade-in-up  [animation-delay:200ms]">
            <div className="relative aspect-square rounded-3xl overflow-hidden mb-4">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 rounded-full bg-white/90 text-primary text-xs font-bold uppercase tracking-wider shadow-sm">Từ 5-10 tuổi</span>
              </div>
            </div>
            <h4 className="text-lg font-bold text-white group-hover:text-primary transition-colors">Kể Chuyện Sáng Tạo</h4>
            <div className="flex items-center gap-4 text-slate-500 text-sm mt-1">
              <span className="flex items-center gap-1"><span className="material-symbols-outlined text-base">video_library</span> 40 Bài học</span>
          ...
          <div className="group cursor-pointer animate-fade-in-up  [animation-delay:300ms]">
            <div className="relative aspect-square rounded-3xl overflow-hidden mb-4">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 rounded-full bg-white/90 text-primary text-xs font-bold uppercase tracking-wider shadow-sm">Cơ bản</span>
              </div>
            </div>
            <h4 className="text-lg font-bold text-white group-hover:text-primary transition-colors">Lập trình cho trẻ em</h4>
            <div className="flex items-center gap-4 text-slate-500 text-sm mt-1">
              <span className="flex items-center gap-1"><span className="material-symbols-outlined text-base">view_module</span> 12 Học phần</span>
          ...
          <div className="group cursor-pointer animate-fade-in-up  [animation-delay:400ms]">
            <div className="relative aspect-square rounded-3xl overflow-hidden mb-4">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 rounded-full bg-white/90 text-primary text-xs font-bold uppercase tracking-wider shadow-sm">Chăm sóc bản thân</span>
              </div>
            </div>
            <h4 className="text-lg font-bold text-white group-hover:text-primary transition-colors">Làm mẹ chánh niệm</h4>
            <div className="flex items-center gap-4 text-slate-500 text-sm mt-1">
              <span className="flex items-center gap-1"><span className="material-symbols-outlined text-base">play_circle</span> 15 Video</span>
          ...
          <div className="group cursor-pointer animate-fade-in-up  [animation-delay:500ms]">
            <div className="relative aspect-square rounded-3xl overflow-hidden mb-4">
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 rounded-full bg-white/90 text-primary text-xs font-bold uppercase tracking-wider shadow-sm">Nghệ thuật</span>
              </div>
            </div>
            <h4 className="text-lg font-bold text-white group-hover:text-primary transition-colors">Minh hoạ kỹ thuật số</h4>
            <div className="flex items-center gap-4 text-slate-500 text-sm mt-1">
              <span className="flex items-center gap-1"><span className="material-symbols-outlined text-base">palette</span> 20 Dự án</span>
